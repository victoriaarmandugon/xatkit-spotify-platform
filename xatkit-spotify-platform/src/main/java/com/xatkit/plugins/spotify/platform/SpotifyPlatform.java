...
public class SpotifyPlatform extends RuntimePlatform {
	 ...
	 */
	public @NonNull String getPlaylists(@NonNull StateContext context, @NonNull String searchString) {
		GetPlaylists action = new GetPlaylists(this, context, searchString);
	...
	public @NonNull String getDevicesNameIDs(@NonNull StateContext context, @NonNull String searchString) {
		GetDevicesNameIDs action = new GetDevicesNameIDs(this, context, searchString);
		RuntimeActionResult result = action.call();
		return (String) result.getResult();
	}
