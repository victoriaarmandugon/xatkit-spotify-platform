...
public class AddTrack extends RuntimeAction < SpotifyPlatform > {
    ...
    private static String endpointURL(StateContext context, String username) {
      Object playlist_id = context.getSession().get("playlist-id");
      Object uri = context.getSession().get("track-uri");
    ...
    protected Object compute() throws Exception {
        try{
            ...
            String endpoint = endpointURL(context, this.runtimePlatform.getSpotifyUsername());
